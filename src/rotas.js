...
const { cadastrarTransacao, listarTransacoes, detalharTransacao, atualizarTransacaoPorId, deletarTransacaoPorId, obterExtratoTransacoes } = require('./controladores/transacoes');
